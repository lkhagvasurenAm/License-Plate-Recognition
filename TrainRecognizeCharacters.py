...
def read_training_data(training_directory):
    ...
    for each_letter in letters:
        for each in range(20):
            ...
            # therefore the 40*40 image becomes 1*1600
            # in machine learning terms that's 1600 features with each pixel
...
print('reading data')
training_dataset_dir = r'C:\Users\dell\OneDrive\Desktop\Final\plate_number'
