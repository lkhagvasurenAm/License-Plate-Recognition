...
def detectPlate():
	...
	if(flag == 1):
	    ...
	    # plt.show()
		plt.axis('off')
		plt.savefig('static/images/car.png',bbox_inches='tight')
	if(flag==0):
...
def segmentCharacters():
	if request.method=='POST':
		car_image = imread('static/images/car.png')
		...
		character_dimensions = (0.65*license_plate.shape[0], 0.85*license_plate.shape[0], 0.03*license_plate.shape[1], 0.23*license_plate.shape[1])
		...
		plt.axis('off')
		plt.savefig('static/images/segmented_car.png', bbox_inches='tight')
		print('characters',characters)
		print('column_list',column_list)
		print(type(characters)) # Iska outout kya hau?Lst
		print(type(column_list))
		
	filename = 'static/images/segmented_car.png'
